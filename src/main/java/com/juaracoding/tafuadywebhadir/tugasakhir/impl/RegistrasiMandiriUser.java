...
Version 1.0
*/
public class RegistrasiMandiriUser {
    ...
    private String fileDownloadImageCamera;
    private String fileDownloadImageKehadiran;
...
//    @And("TRUMP024 Input Tipe Absen User")
//    public void trump024_input_tipe_absen_user(){
//        homePageHadirUser.getInputTipeAbsen().click();
//        while (true){
//            if(!homePageHadirUser.getTxtFieldTipeAbsen().isEmpty()){
//                homePageHadirUser.getTxtFieldTipeAbsen().get(0).click();
//                extentTest.log(LogStatus.PASS, "TRUMP022 Input Tipe Absen User");
//                break;
//            }else{
//                extentTest.log(LogStatus.FAIL, "TRUMP022 Input Tipe Absen User");
//                break;
//            }
//        }
//        extentTest.log(LogStatus.PASS, "TRUMP024 Input Tipe Absen");
//    }
    ...
    public void trump024_download_image_hasil_absen(){
        fileDownloadImageCamera = pathRootHasilDownloadUser +"\\"+new SimpleDateFormat("ddmmyyyyHHMMssSSS").format(new Date())+"_HasilCamera.jpg";
    ...
    public void trump025_input_nama_di_field_search_nama(){
        kehadiranPageAdmin.getInputSeachKehadiran().sendKeys("Pandu Lesmana");
    ...
    public void trump025_validasi_hasil_search(){
        ...
        boolean validasi = namaLengkap.equalsIgnoreCase("Pandu Lesmana");
        System.out.println(validasi);
        if (validasi == true){
...
//        fileDownloadImageKehadiran = pathRootHasilDownloadAdmin +"\\"+new SimpleDateFormat("ddmmyyyyHHMMssSSS").format(new Date())+"_HasilKehadiran.jpg";
//        // Ambil elemen gambar
//        WebElement imgElement = kehadiranPageAdmin.getImageTableKehadiran();
//
//        // Periksa jika elemen gambar ditemukan
//        if (imgElement != null) {
//            strLinkAbsenKehadiran = imgElement.getAttribute("src");
//        } else {
//            strLinkAbsenKehadiran = "";
//        }
//
//        // Validasi jika link gambar tidak ditemukan
//        if (strLinkAbsenKehadiran.isEmpty()) {
//            Assert.fail("Link Gambar Tidak Ditemukan");
//            return;
//        }
//
//        GlobalFunction.downloadImage(strLinkAbsenCamera,fileDownloadImageKehadiran);
        List<WebElement> imgElements = kehadiranPageAdmin.getImageElementsInTable();

        if (imgElements == null || imgElements.isEmpty()) {
            Assert.fail("Tidak ada gambar ditemukan di tabel.");
            return;
        }
        ...
        for (WebElement imgElement : imgElements) {
            ...
            if (src != null && !src.isEmpty()) {
                String fileName = pathRootHasilDownloadAdmin + "\\" + new SimpleDateFormat("ddMMyyyyHHmmssSSS").format(new Date()) + "_HasilKehadiran.jpg";
                GlobalFunction.downloadImage(src, fileName);
                extentTest.log(LogStatus.PASS, "Gambar berhasil diunduh dari: " + src);
            } else {
                System.out.println("Gambar dengan src null atau kosong ditemukan.");
            }
        }
